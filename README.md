...
- 日常协调器使用 `anyrouter/gpt-5.6-sol`，失败后依次回退到 `openai-codex/gpt-5.6-sol-900k` 和 `micu-api/gpt-5.6-terra`。AnyRouter 只承载 GPT；其 Claude 系列在实际使用中不可用，已于 2026-09 连同对应的 Hermes 源码补丁一起移除。
